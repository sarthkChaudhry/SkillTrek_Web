    ...
    <div className="sideBar">
      <div className="sideBarWrapper">
        <div className="sideBarMenu">
          ...
          <Link to='/addusercalender' style={{textDecoration:'none',color:'#606060'}}> <li className="sideBarListItem active"><i className="far fa-calendar sideBarIcon" />Calendar</li></Link>
          </ul>
        </div>
      </div>
    </div>
